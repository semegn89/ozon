...
TEXTS = {
    'ru': {
        ...
        'models_list': "Выберите модель:\n\n💡 Нажмите на название модели для просмотра опций",
        ...
        # Recipes
        'recipes': "🍽️ Рецепты",
        'recipes_list': "Рецепты для модели <b>{model_name}</b>:",
        'recipe_sent': "Рецепт отправлен.",
        'recipe_unavailable': "Рецепт временно недоступен.",
        'download_recipes_package': "⬇️ Скачать все рецепты",
        'recipes_package_sent': "Комплект рецептов отправлен.",
        ...
        'recipe_title_prompt': "Введите название рецепта:",
        'recipe_type_prompt': "Выберите тип рецепта:",
        'recipe_description_prompt': "Введите описание (или /skip для пропуска):",
        'recipe_file_prompt': "Загрузите файл или отправьте URL:",
        'recipe_created': "Рецепт '{title}' создан!",
        'recipe_updated': "Рецепт '{title}' обновлен!",
        'recipe_deleted': "Рецепт '{title}' удален!",
        'bind_recipe_to_models': "Привязать к моделям",
        'recipe_bound': "Рецепт привязан к моделям!",
        'select_models_to_bind_recipe': "Выберите модели для привязки рецепта '{title}':",
        'recipe_already_bound': "Рецепт уже привязан к выбранным моделям.",
        'unbind_recipe_from_models': "🔓 Отвязать от моделей",
        'recipe_unbound': "Рецепт отвязан от моделей!",
        'select_models_to_unbind_recipe': "Выберите модели для отвязки рецепта '{title}':",
        'recipe_not_bound': "Рецепт не привязан к выбранным моделям.",
